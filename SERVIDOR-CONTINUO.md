...
7. Para comprobar respuesta, usar `/posiciones` y, si se desea seguir BTC, `/seguir BTCUSD 1h long`. Esto solo registra seguimiento. Una respuesta confirma comunicación; que no haya alertas inmediatamente puede ser correcto si no hay condiciones nuevas.
